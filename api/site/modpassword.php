...
$password = addslashes($data_primite['password']);

$sql = 'UPDATE `users_pop` SET `passwrd`="'.$password.'" WHERE `user` LIKE "'.$email.'" LIMIT 1'; 	// ca sa nu afecteze mai multe randuri din baza de date o eventuala greseala sau injectie
$rez = mysql_query($sql);
